                    ...
                    <div class="quizOptions rounded  p-1">
                         <form method="post", action="#">
                              <ul class="list-group options m-1 ">
                                   <li><button  class="btn m-1 ">OPTION 1 </button></li>
                                   <li><button class="btn m-1 ">OPTION 2</button></li>
                                   <li><button class="btn m-1 ">OPTION 3</button></i></li>
                                   <li><button class="btn m-1 ">OPTION 4</button></li>
                              </ul>     
                         </form>
                    </div>
                    <div class="quizQuit  rounded m-1 mx-auto absolute-bottom">
                         <form method="post" action="# " class="mx-auto">
                              <button class="btn m-1"> < </button>
                              <button type="submit "  class="btn m-1">QUIT</button>
                              <button class="btn m-1"> > </button>
                         </form>
                    </div>
